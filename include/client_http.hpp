...
public:
	...
	class Response {
		...
		Response(std::size_t max_response_streambuf_size) : streambuf(max_response_streambuf_size), content(streambuf) {}
...
protected:
	...
	ClientBase(const std::string &host_port, unsigned short default_port) : handler_runner(new ScopeRunner()) {
