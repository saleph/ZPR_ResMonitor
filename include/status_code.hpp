...
inline const std::map<StatusCode, std::string> &status_code_strings() {
	static const std::map<StatusCode, std::string> status_code_strings =
			{ { StatusCode::unknown, "" }, { StatusCode::information_continue,
					"100 Continue" }, {
					...
					{ StatusCode::success_multi_status, "207 Multi-Status" }, {
							StatusCode::success_already_reported,
					...
					{ StatusCode::redirection_see_other, "303 See Other" }, {
							StatusCode::redirection_not_modified,
							"304 Not Modified" },
					{ StatusCode::redirection_use_proxy, "305 Use Proxy" }, {
							StatusCode::redirection_switch_proxy,
							"306 Switch Proxy" }, {
							...
							"401 Unauthorized" }, {
							StatusCode::client_error_payment_required,
					...
					{ StatusCode::client_error_gone, "410 Gone" }, {
							...
							StatusCode::client_error_im_a_teapot,
							"418 I'm a teapot" }, {
							...
							StatusCode::client_error_failed_dependency,
							"424 Failed Dependency" }, {
							StatusCode::client_error_upgrade_required,
							"426 Upgrade Required" }, {
							StatusCode::client_error_precondition_required,
							"428 Precondition Required" }, {
							StatusCode::client_error_too_many_requests,
					...
					{ StatusCode::client_error_unavailable_for_legal_reasons,
							...
							StatusCode::server_error_not_implemented,
							"501 Not Implemented" }, {
							StatusCode::server_error_bad_gateway,
							"502 Bad Gateway" }, {
							StatusCode::server_error_service_unavailable,
							"503 Service Unavailable" }, {
							StatusCode::server_error_gateway_timeout,
							"504 Gateway Timeout" }, {
							...
							"508 Loop Detected" }, {
							StatusCode::server_error_not_extended,
							"510 Not Extended" },
...
inline StatusCode status_code(const std::string &status_code_string) {
	class StringToStatusCode: public std::unordered_map<std::string,
